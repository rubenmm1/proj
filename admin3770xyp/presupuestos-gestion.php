        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    ...
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Presupuestos</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/
                                <?php echo $titulo; ?>
                            </span>
                        </div>
                    </div>
                            ...
                            <div class="card card-invoice">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive mg-t-40">
                                        ...
                                        <textarea id=observaciones name=observaciones rows=4 style='width:100%;border:none;background-color:#edecec;font-size:13px;padding:10px;'><?php if (isset($observaciones)) {
                                                                                                                                                                                        echo $observaciones;
                                                                                                                                                                                    } ?></textarea>
                                    </div>
                                    <hr class="mg-b-40">
